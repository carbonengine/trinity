...
namespace TrinityALImpl
{
	...
	{
		return m_presentParam.BackBufferWidth;
	}
	...
	{
		return m_presentParam.BackBufferHeight;
	}

	void Tr2SwapChainAL::Describe( Tr2DeviceResourceDescriptionAL& description ) const
	{
		description["type"] = "Tr2SwapChainAL";
		description["width"] = std::to_string( long long( m_presentParam.BackBufferWidth ) );
		description["height"] = std::to_string( long long( m_presentParam.BackBufferHeight ) );
	}
}
