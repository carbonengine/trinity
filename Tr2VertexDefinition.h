...
public:
	...
	struct Item
	{
		...
		bool operator<( const Item& other ) const { return m_offset < other.m_offset; }
	};
	...
	{ 
		...
		{
		case DT_INT8	: return size;
		case DT_INT16	: return size * 2;
		case DT_INT32	: return size * 4;
		case DT_FLOAT16	: return size * 2;
		case DT_FLOAT32	: return size * 4;
		}
		return 0;
	}
};
