...
#define TEST_( category, name, parent ) struct Test_##category##name: public parent { void Run(); }; \
	struct Test_##category##name##_Factory { Test_##category##name##_Factory() { \
...
#define ASSERT_EQ( val1, val2 ) { if( (val1) != (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 == val2\n", __FILE__, __LINE__ ); return; } };
#define ASSERT_NE( val1, val2 ) { if( (val1) == (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 != val2\n", __FILE__, __LINE__ ); return; } };
#define ASSERT_TRUE( val1 ) { if( !(val1) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 == true\n", __FILE__, __LINE__ ); return; } };
#define ASSERT_FALSE( val1 ) { if( (val1) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 == false\n", __FILE__, __LINE__ ); return; } };

#define EXPECT_EQ( val1, val2 ) { if( (val1) != (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 == val2\n", __FILE__, __LINE__ ); } };
#define EXPECT_NE( val1, val2 ) { if( (val1) == (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 == val2\n", __FILE__, __LINE__ ); } };
#define EXPECT_GT( val1, val2 ) { if( (val1) <= (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 > val2\n", __FILE__, __LINE__ ); } };
#define EXPECT_GE( val1, val2 ) { if( (val1) < (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 >= val2\n", __FILE__, __LINE__ ); } };
#define EXPECT_LE( val1, val2 ) { if( (val1) > (val2) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected val1 <= val2\n", __FILE__, __LINE__ ); } };
#define EXPECT_TRUE( val ) { if( !( val ) ) { FailCurrentTest(); PrintMessage( "%s (%i): expected true, got false\n", __FILE__, __LINE__ ); } };
#define EXPECT_FALSE( val ) { if( val ) { FailCurrentTest(); PrintMessage( "%s (%i): expected false, got true\n", __FILE__, __LINE__ ); } };

#define ASSERT_HRESULT_SUCCEEDED( hr ) { HRESULT ___hr = (HRESULT)(hr); if( ___hr < 0 ) { FailCurrentTest(); PrintMessage( "%s (%i): expected SUCCEEDED HRESULT, got FAILED (%i)\n", __FILE__, __LINE__, int( ___hr ) ); return; } };
#define ASSERT_HRESULT_FAILED( hr ) { HRESULT ___hr = (HRESULT)(hr); if( ___hr >= 0 ) { FailCurrentTest(); PrintMessage( "%s (%i): expected FAILED HRESULT, got SUCCEEDED (%i)\n", __FILE__, __LINE__, int( ___hr ) ); return; } };
