...
#include INCLUDE_SHADER_CODE( OutputVector.cs )
	...
	ASSERT_HRESULT_SUCCEEDED( output.Create( 1, PIXEL_FORMAT_R32G32B32A32_FLOAT, USAGE_CPU_READ, nullptr, *renderContext ) );
...
#include INCLUDE_SHADER_CODE( AddVectors.cs )
	...
	Tr2GpuBufferAL arg1;
	ASSERT_HRESULT_SUCCEEDED( arg1.Create( 1, PIXEL_FORMAT_R32G32B32A32_FLOAT, USAGE_CPU_READ, data1, *renderContext ) );
	Tr2GpuBufferAL arg2;
	ASSERT_HRESULT_SUCCEEDED( arg2.Create( 1, PIXEL_FORMAT_R32G32B32A32_FLOAT, USAGE_CPU_READ, data2, *renderContext ) );
...
#include INCLUDE_SHADER_CODE( GroupShared.cs )
	...
	Tr2GpuBufferAL output;
	ASSERT_HRESULT_SUCCEEDED( output.Create( 1, PIXEL_FORMAT_R32_UINT, USAGE_CPU_READ, nullptr, *renderContext ) );
