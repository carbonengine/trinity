	...
	Tr2PrimaryRenderContextAL &renderContext )
{
	...
	ConvertUsage( usage, gpuUsage, cpuUsage );
	return Create( Tr2BitmapDimensions( width, height, mipLevelCount, format ), gpuUsage, cpuUsage, initialData, renderContext );
}
	...
	Tr2PrimaryRenderContextAL &renderContext )
{
	...
	Tr2CpuUsage::Type cpuUsage;
	ConvertUsage( usage, gpuUsage, cpuUsage );
	return Create( Tr2BitmapDimensions( Tr2RenderContextEnum::TEX_TYPE_2D, format, width, height, 1, mipLevelCount, arrayCount ), gpuUsage, cpuUsage, initialData, renderContext );
}
	...
	Tr2PrimaryRenderContextAL &renderContext )
{
	...
	Tr2CpuUsage::Type cpuUsage;
	ConvertUsage( usage, gpuUsage, cpuUsage );
	return Create( Tr2BitmapDimensions( Tr2RenderContextEnum::TEX_TYPE_CUBE, format, width, height, 1, mipLevelCount ), gpuUsage, cpuUsage, initialData, renderContext );
}
	...
	Tr2PrimaryRenderContextAL &renderContext )
{
	...
	return Create( Tr2BitmapDimensions( Tr2RenderContextEnum::TEX_TYPE_3D, format, width, height, depth, mipLevelCount ), gpuUsage, cpuUsage, initialData, renderContext );
}

ALResult Tr2TextureAL::CreateRenderTarget(
	uint32_t width,
	uint32_t height,
	uint32_t mipLevelCount,
	Tr2RenderContextEnum::PixelFormat format,
	...
	Tr2PrimaryRenderContextAL &renderContext )
{
	auto gpuUsage = Tr2GpuUsage::RENDER_TARGET;
	...
	else if( ( usage & Tr2RenderContextEnum::USAGE_UNORDERED_ACCESS ) != 0 )
	{
		gpuUsage = gpuUsage | Tr2GpuUsage::UNORDERED_ACCESS;
	}
	...
	return Create( Tr2BitmapDimensions( width, height, mipLevelCount, format ), msaa, gpuUsage, cpuUsage, nullptr, renderContext );
}

ALResult Tr2TextureAL::CreateDepthStencil(
	uint32_t width,
	uint32_t height,
	...
	Tr2PrimaryRenderContextAL& renderContext )
{
	...
	return Create( Tr2BitmapDimensions( width, height, 1, Tr2RenderContextEnum::ConvertDepthStencilFormat( format ) ), msaa, gpuUsage, renderContext );
}
