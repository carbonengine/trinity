...
BLUE_CLASS( Tr2VisibilityResults ) : public IRoot
{
public:
	...
	size_t GetNumVisibilityEvents( void ) const { return m_events.size(); }
	// Clears the result set
	void Clear( void );
	// Get the list of events
	const std::vector<Tr2VisibilityEvent>& GetEvents( void ) const { return m_events; }
