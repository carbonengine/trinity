...
const Be::ClassInfo* EveChildMesh::ExposeToBlue()
{
    EXPOSURE_BEGIN( EveChildMesh, "" )
		...
		MAP_ATTRIBUTE( "overwriteMorphTargetAnimations", m_overwriteMorphTargetAnimations, "use manually set morph target weights instead of weights read from animations for debugging purposes", Be::READWRITE )
