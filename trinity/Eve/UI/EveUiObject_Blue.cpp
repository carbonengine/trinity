...
const Be::ClassInfo* EveUiObject::ExposeToBlue()
{
	EXPOSURE_BEGIN( EveUiObject, "" )
		...
		MAP_METHOD_AND_WRAP( "GetNameForPickingAreaID", GetNameForPickingAreaID,
			"Get a unique name for the area ID provided by the scene picking\n"
			":param areaID: index provided by the picking" )
		MAP_METHOD_AND_WRAP( "SetVisibilityForArea", SetVisibilityForArea,
			"Change visibility of an area of this object\n"
